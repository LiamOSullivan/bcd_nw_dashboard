...
Promise.all([
  ...
  // nest the processed data by regions
  const contributionDataNested = d3.nest().key(d => {
      return d[contributionRegions];
    })
  ...
  // nest the processed data by regions
  const housePricesDataNested = d3.nest().key(d => {
      return d[housePricesRegions];
    })
  ...
  // nest the processed data by regions
  const rentPricesDataNested = d3.nest().key(d => {
      return d[rentPricesRegions];
    })
  ...
  // nest the processed data by regions
  const houseCompByTypeDataNested = d3.nest().key(d => {
      return d[houseCompByTypeRegions];
    })
  ...
  // nest the processed data by regions
  const newCompByTypeDataNested = d3.nest().key(d => {
      return d[newCompByTypeRegions];
    })
