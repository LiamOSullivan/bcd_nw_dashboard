d3.csv("../data/Education/school_enrollments.csv")
  .then(function(data) {
...
d3.csv("../data/Education/lit_enrollments_2015.csv")
  .then(function(data) {
    let enrollLit = {
      y: data.map((v) => {
    ...
    let enrollLitLayout = Object.assign({}, rowChartLayout);
    enrollLitLayout.title = 'Letterkenny IT Enrollments 2015';
...
d3.csv("../data/Education/uu_enrollments_2015.csv")
  .then(function(data) {
    let enrollUu = {
      y: data.map((v) => {
    ...
    let enrollUuLayout = Object.assign({}, rowChartLayout);
    enrollUuLayout.title = 'Ulster University Enrollments 2015';
